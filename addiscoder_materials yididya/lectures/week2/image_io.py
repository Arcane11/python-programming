...
directory. Modified by Alex Krentsel for AddisCoder 2023."""
...
# TODO(akrentsel): Play around to make sure this works. I want this to display
# inline in the Jupyter notebook.
def display_image(image_matrix):
    """
    Display an image matrix in a new window.

    Parameters:
    image_matrix: {list of lists of lists} Matrix to display.
    """
    if not image_matrix or not image_matrix[0]:
        raise ValueError("Cannot display image matrix with 0 width or height")
